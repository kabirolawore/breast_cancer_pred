...
def add_predictions(input_data):
    ...
    # print('dataframe', input_df.head(1))

    # Ensure that the columns in input_df match the original feature names
...
def app():
    ...
    with st.container():
        ...
        st.write("""
            Please connect this app to your cytology lab to help diagnose breast cancer form your 
            tissue sample. This app predicts using a machine learning model whether a breast mass 
            is benign or malignant based on the measurements it receives from your cytosis lab. 
